...
if [ ! -f /var/lib/mldonkey/downloads.ini ]; then
    ...
    # Nombre del cliente
    /usr/lib/mldonkey/mldonkey_command -p "" "set client_name emc2" "save"
    ...
    /usr/lib/mldonkey/mldonkey_command -p "" "passwd 'P@ssw0rd'"
    /usr/lib/mldonkey/mldonkey_command -p 'P@ssw0rd' "kill"
